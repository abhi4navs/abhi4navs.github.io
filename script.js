...
const CMD = {
  ...
  whoami() {
    ...
    [
      ...
      const d = document.createElement('div');
      d.className = 'fi';
      d.style.cssText = 'font-family:var(--font);font-size:12px;line-height:1.4;color:var(--green);text-shadow:0 0 14px rgba(168,255,120,0.5);white-space:pre;letter-spacing:0;';
      d.textContent = a;
      out.appendChild(d);
    });
    blank();
  ...
  contact() {
    ...
    blank();
    ir('📧 Email',    `<span style="color:var(--green)">abhinavcyber10@gmail.com</span>`);
    ir('🐙 GitHub',   `<span style="color:var(--purple)">github.com/abhi4navs</span>`);
    ir('💼 LinkedIn', `<span style="color:var(--cyan)">linkedin.com/in/Abhinav-kumar-33047b265</span>`);
